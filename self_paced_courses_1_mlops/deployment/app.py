...
model_path = hf_hub_download(repo_id="umangagarwal1008/PIMA-Diabetes-Prediction", filename="best_pima_diabetes_model_v1.joblib", repo_type="model")                                       # enter the Hugging Face username here
